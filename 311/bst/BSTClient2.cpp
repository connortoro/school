...
int main()
{
  ...
  cout << "\ntesting removing a node with 2 children. the largest value in the left subtree is the direct left child of the node to be deleted" << endl;
  b6.remove(20);
  b6.inOrderPrint();
  ...
  cout << "\ntesting removing a node with 2 children. the largest value in the left subtree is NOT the direct left child of the node to be deleted" << endl;
  b7.remove(20);
  b7.inOrderPrint();
